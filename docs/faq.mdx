...
You can refer to the mapping table that provides detailed information on the frequency allocations per country by visiting the  [frequencies plans](/wxm-devices/frequency-plans) page.
