...
The WXM token will be used to govern the Network and will be required to license weather data for commercial uses. Station owners are awarded $WXM for providing high-quality weather data to the Network.
