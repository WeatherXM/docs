...
[WXM](https://mumbai.polygonscan.com/token/0xecbbbf304fdf91cddda6c6643ed1300a552b691a) is currently implemented in [Arbitrum Sepolia Testnet](https://sepolia.arbiscan.io/address/0xbacef2640862b42eeccfeab9bf750476ae7decc6) as an ERC20 token rewarding the closed beta user group.
...
| ---------------------------| ----------- | -------------- |
| **Daily Station Rewards**      | 52%         | 52,000,000 WXM |
...
30M tokens will be used to reward the company and the investors for their contributions and work. They will be unlocked daily using a 10-10-80% distribution in the first 3 years.
...
:::note
To understand better the "Airdrop" you can read the related blog post <a href="https://blog.weatherxm.com/the-wxm-beta-rewards-program-fe2cbb9778b0">here</a>
:::
...
- 10M tokens will be liearly unlocked the first 5 years. These tokens will be used to support and fund the ecosystem development.
