...
:::note
To understand better the "Beta rewards" you can read the related blog post <a href="https://blog.weatherxm.com/the-wxm-beta-rewards-program-fe2cbb9778b0">here</a>
:::
