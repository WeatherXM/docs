...
<section class="product-container">
  <div class="device" >
    <Link to="wxm-devices/Pulse-bundle/pulse-bundle-introduction">
      <img src={useBaseUrl("/img/wxm-devices/pulse-bundle/pulse_bundle.png")} />
      <div class="device-info" >
        <h4>WeatherXM Pulse bundle (WB3000)</h4>
        <p>The WB3000 is a bundle product that combines the WS1001 weather station with WeatherXM WG3000 Cellurar Gateway.</p>
      </div>
    </Link>
  </div>
</section>
