...
sidebar_label: WiFi M5 Bundle with Weather Station
...
1. Find the best possible place in your area according to the criteria (see [Good practice guides for placing the outdoor sensor](/wxm-devices/wifi-m5-bundle/setup/setup-weather-station#good-practice-guides-for-placing-the-outdoor-sensor)).
...
- [Contents](/wxm-devices/wifi-m5-bundle/setup/contents)
- [Setting up the Weather Station](/wxm-devices/wifi-m5-bundle/setup/setup-weather-station)
- [Setting up WXM-M5](/wxm-devices/wifi-m5-bundle/setup/setup-m5)
- [Troubleshooting](/wxm-devices/wifi-m5-bundle/setup/troubleshooting)
