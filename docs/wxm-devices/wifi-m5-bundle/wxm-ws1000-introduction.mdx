...
title: WeatherXM M5 bundle (WB1000) Introduction
hide_title: false
...
<Link to="/wxm-devices/wifi-m5-bundle/m5-contents">View Contents</Link>
...
<Link to="/wxm-devices/wifi-m5-bundle/assemble-m5">View Station Assembly Instructions</Link>
...
<Link to="/wxm-devices/wifi-m5-bundle/install-weather-station">View Station Installation Instructions</Link>
...
<Link to="/wxm-devices/wifi-m5-bundle/m5-connect-and-claim">View Connect and Claim Instructions</Link>
