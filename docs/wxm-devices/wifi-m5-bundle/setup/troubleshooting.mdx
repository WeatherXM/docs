...
slug: /wxm-devices/wifi-m5-bundle/setup/troubleshooting
---
...
Check the transmitter LED on the outdoor sensor (see [Fig. 4] and [Reset Button and Transmitter LED](/wxm-devices/wifi-m5-bundle/setup/setup-weather-station#reset-button-and-transmitter-led) for flashing.
...
1. If you still have intermittent problems, move the outdoor sensor and the WXM-M5 closer together,
   but not closer than 5 ft (1.5m). Also check that there are no metal barriers like aluminum siding,
...
1. Use the external RF antenna provided with M5, but this requires you open the M5 (see [Switch external/internal Radio Function (RF) - LoRa antenna](/wxm-devices/wifi-m5-bundle/setup/setup-m5##switch-externalinternal-radio-function-rf---lora-antenna)).
...
Make also sure that the outdoor sensor is mounted on a 2 (or more) meter metallic pole and there are no obstacles close by (see [Good practice guides for placing the outdoor sensor](/wxm-devices/wifi-m5-bundle/setup/setup-weather-station#good-practice-guides-for-placing-the-outdoor-sensor)).
...
If there are deviations, please check [Good practice guides for placing the outdoor sensor](/wxm-devices/wifi-m5-bundle/setup/setup-weather-station#good-practice-guides-for-placing-the-outdoor-sensor) for guidelines about the installation of the outdoor sensor.
...
If the problem remains and you use the internal GPS antenna, switch into the external antenna (see [Switch external/internal GPS antenna](/wxm-devices/wifi-m5-bundle/setup/setup-m5#switch-externalinternal-gps-antenna)).
