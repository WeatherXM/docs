...
1. the wireless transmission of the data to the weather Gateway.
...
<div class="control">
  ...
  <div>
    <p>
      The M5 Gateway is the device responsible for receiving weather measurements from the outdoor sensor and transmitting them via WiFi to IPFS and the WeatherXM network.
      The M5 Gateway is advised to be placed indoors, in an environment of relatively constant temperature (ideally within a daily range of &#60;4°C/7°F for proper functioning of the barometer),
      near a window (for better GPS signal). The M5 Gateway should be permanently connected to power and powered on in order to be able to receive, record and upload measurements to the Internet.
