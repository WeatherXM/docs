...
title: Installing theWeatherXM M5 bundle Weather station
sidebar_label: Installing theWeatherXM M5 bundle
...
[![Instruction on how to install the WG1000 Gateway WeatherXM weather station](/img/wxm-devices/wifi-m5-bundle/video-setup-installation.png)](https://www.youtube.com/watch?v=J-dSXNLX4nk&ab_channel=WeatherXM)
...
<div class="explanation">
  <img src={useBaseUrl("img/wxm-devices/wifi-m5-bundle/pole-assembly.svg")} />
    ...
    Thus, it is important that you are able to read all the measurements on the WG1000 Gateway's screen,
    while you keep the outdoor sensor nearby (preferably not closer than 1.5m/5ft from the WG1000 Gateway though).<br />
