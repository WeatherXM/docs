...
1. Location and spacing (<Link to="/wxm-devices/wifi-m5-bundle/install-weather-station#best-practices-for-proper-station-installation">Best practices for proper station installation</Link>)
