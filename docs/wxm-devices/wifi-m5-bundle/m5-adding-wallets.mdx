---
id: m5-adding-wallets
title: Adding Wallets
sidebar_label: Adding Wallets
slug: /wxm-devices/wifi-m5-bundle/adding-wallet
---
...
## All steps below this point are optional

:::note
If you want to confirm the existence of your tokens in your prefered wallet, you need to add our ERC20 token's smart contract.
:::
...
1. [Using Polygonscan](/wxm-devices/wifi-m5-bundle/adding-wallet#using-polygonscan) **(Only for Desktop with MetaMask browser extension already installed)**
1. [Add the Polygon network manually](/wxm-devices/wifi-m5-bundle/adding-wallet#add-the-polygon-network-manually)
