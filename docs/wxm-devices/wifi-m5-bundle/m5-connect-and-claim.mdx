...
Please follow the instructions below, or on this [video](https://www.youtube.com/watch?v=FP4rT3FTz0M&t).
...
:::caution
If M5 turns off, you will not receive WXM rewards, as you won't be able to share data with the Network
:::
...
Download our WXM apps from their respected app stores. Once you have your WXM app, login to your account (same credentials you used to order your station). If you don't remember your credentials, you can always [reset your password](https://weatherxm.com).
...
<img src={useBaseUrl("img/wxm-devices/wifi-m5-bundle/m5-aserial.png")} />

<section class="explanation">
  <img src={useBaseUrl("img/wxm-devices/wifi-m5-bundle/serial-number.png")} />
  <div>
    <h4>Type in the Serial Number of your M5</h4>
    <p>
      Follow the steps shown in the image above to find your M5's Serial Number. You'll need to type this in the WXM app in order to verify that you own this station, and secure it for yourself.
    </p>
  </div>
</section>
