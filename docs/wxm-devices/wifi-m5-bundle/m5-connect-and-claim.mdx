...
All you need to do now, is to add your compatible wallet so you can receive WXM rewards. To do so, please follow the instructions in the next chapetr ["Adding Wallets"](/adding-wallet/adding-wallet). **Remember that as of today, the WXM token is on testnet!**
