...
[![Instruction on how to switch to LoRaWan antenna](/img/wxm-devices/wifi-m5-bundle/video-LoRaWan.png)](https://www.youtube.com/watch?v=FP4rT3FTz0M&)

  </span>
</section>

:::caution
If the station and M5 are more than 50m apart, you must install the LoRaWan antenna. Else the station might not be able to properly communicate with M5, resulting in less to none data being shared to the network, and thus reduce WXM rewards.
:::
...
All you need to do now, is to add your compatible wallet so you can receive WXM rewards. To do so, please follow the instructions in the next chapetr ["Adding Wallets"](/wxm-devices/wifi-m5-bundle/adding-wallet). **Remember that as of today, WXM are on testnet!**
