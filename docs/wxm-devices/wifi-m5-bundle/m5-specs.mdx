...
Powered via a small solar panel and batteries and communicates with the M5 Gateway via RF (Radio Frequencies).
...
Powered via a small solar panel and batteries and communicates with the M5 Gateway via RF (Radio Frequencies).
The maximum distance between this station and the M5 Gateway is 328ft with line of sight.
- #### Temperature:
