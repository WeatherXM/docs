...
1. Location and spacing (<Link to="/wxm-devices/pulse-bundle/install-weather-station#best-practices-for-proper-station-installation">Best practices for proper station installation</Link>)
