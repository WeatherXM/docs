...
title: WeatherXM Pulse bundle (WB3000) Introduction
hide_title: false
sidebar_label: WeatherXM Pulse bundle Introduction
...
<Link to="/wxm-devices/Pusle-bundle/pulse-contents">View Contents</Link>
