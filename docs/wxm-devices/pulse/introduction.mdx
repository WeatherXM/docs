...
<Link to="/wxm-devices/pulse/contents">View Contents</Link>
...
<Link to="/wxm-devices/pulse/assemble">View Station Assembly Instructions</Link>
...
<Link to="/wxm-devices/pulse/install-weather-station">View Station Installation Instructions</Link>
...
<Link to="/wxm-devices/pulse/connect-and-claim">View Connect and Claim Instructions</Link>
