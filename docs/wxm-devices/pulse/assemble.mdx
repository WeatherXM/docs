...
Loosely screw the nuts on the ends of the U-bolts. They will be tightened later when mounting on the pole (see [Mounting the outdoor sensor](/wxm-devices/pulse/install-weather-station#mounting-the-outdoor-sensor).
