...
1. Location and spacing (<Link to="/wxm-devices/m5/install-weather-station#best-practices-for-proper-station-installation">Best practices for proper station installation</Link>)
