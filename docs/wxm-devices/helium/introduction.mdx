...
<Link to="/wxm-devices/helium/contents">View Contents</Link>
...
<Link to="/wxm-devices/helium/assemble">View Station Assembly Instructions</Link>
...
<Link to="/wxm-devices/helium/connect-and-claim">View Connect and Claim Instructions</Link>
...
<Link to="/wxm-devices/helium/install-weather-station">View Station Installation Instructions</Link>
