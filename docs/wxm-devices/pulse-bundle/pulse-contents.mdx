...
The Pulse Gateway is advised to be placed outdoors, ideally on a the same pole as the Weather Station, to ensure the best possible connection to the cellular network and with the Weather Station.
