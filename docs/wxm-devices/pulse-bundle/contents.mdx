...
<img src={useBaseUrl("img/wxm-devices/pulse-bundle/contents-included-pulse.png")}
  ...
  <div>
    ...
    <ol>
      ...
      <li>Wind vane</li>
      <li>Bracket (for WG3000)</li>
      <li>Bracket (for pole mounting)</li>
      <li>Jubilee clips (x2)</li>
      <li>Screws for securing the bracket to WG3000 (x3)</li>
...
### WG3000 Gateway (Pulse Gateway)

<div class="control">
  <img src={useBaseUrl("/img/wxm-devices/pulse-bundle/pulse.png")} style={{ width: '60%', height: 'auto' }} />
</div>
