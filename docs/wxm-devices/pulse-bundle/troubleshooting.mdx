---
id: troubleshooting
title: Troubleshooting of Pulse Bundle (WB3000)
sidebar_label: Troubleshooting
slug: /wxm-devices/pulse-bundle/troubleshooting
---
...
First make sure you WG3000 Gateway frequency matches your weather station (see [Change frequency](/wxm-devices/pulse-bundle/connect-and-claim#change-frequency-optional)
Check the LED on the weather station (see [Reset Button and LED Indicator](/wxm-devices/pulse-bundle/assemble-weather-station) for flashing.
...
2. Try to place the WG3000 Gateway at the desirable point and check that it receives data.

3. If you still have intermittent problems, move the weather station and the WG3000 Gateway closer together,
...
Assuming that the WG3000 Gateway unit is placed outdoors facing south, this may be due to a bad RF connection between that Gateway and the outdoor station.
