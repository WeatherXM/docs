...
### Installing Spike Rings
The spike rings are designed to be installed on the rim of the rain cup to deter birds from perching on or around 
the rain cup. 
...
#### Installation Instructions
  ...
  2.	Insert the Spikes: Place a metal spike into each hole on the spike holder.
	<div class="control">
  <img src={useBaseUrl("img/wxm-devices/ws-1001/spike_rings_1.png")} />
</div>
  ...
  <div class="control">
  <img src={useBaseUrl("img/wxm-devices/ws-1001/spike_rings_2.png")} />
</div>
...
<div class="control">
  <img src={useBaseUrl("img/wxm-devices/ws-1001/spike_rings_3.png")} />
</div>
