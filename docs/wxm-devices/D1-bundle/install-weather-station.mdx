...
title: Installing the WXM-WS1001 Weather station
sidebar_label: Installing the WXM-WS1001
...
<div class="explanation">
  <img src={useBaseUrl("img/wxm-devices/wifi-m5-bundle/pole-assembly.svg")} />
    ...
    Thus, it is important that you are able to read all the measurements on the D1 Gateway's screen,
    while you keep the outdoor sensor nearby (preferably not closer than 1.5m/5ft from the D1 Gateway though).<br />
