...
The Helium station is reset to factory settings by pressing and holding the reset button for ~10 seconds. When released, a pulsating red indicator should be displayed to the right of it. This indicates a successful reset to the factory settings of the helium station.
