...
3. Deployment status 
    * Indoor Station Detector (ISD) (Data Qualuty v1.1)
...
><img src={useBaseUrl("/img/rewards/qod-components-data-annotations.png")} alt="The Data Quality Components" />
...
- [Technical description of the process for Data Quality v1.0](https://docs.google.com/document/d/e/2PACX-1vRAkDVFpRxqZyP0CAAEtqxtE61VTpAnP02k25BB25F9HUcvIILwBX4-gKt6YP4f1L3mSN2SLNK5aKzJ/pub)