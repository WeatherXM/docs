...
$$RewardableBetaHours[s]$$: This is the total number of hours the station provided valid data during the Beta period.
A rewardable hour is an hour during which the station sent at least one valid weather data point.

$$StationBetaRewards[s]$$: This is the percentage of the 3M tokens that correspond to the rewardable hours the station provided.
$$
StationBetaRewards[s] = \frac{3000000 \times \text{RewardableBetaHours}[s]}{\sum (\text{RewardableBetaHours of all stations})}
$$
