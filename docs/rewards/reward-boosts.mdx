...
**Reward boosts** are additional rewards given to devices that contribute weather data during daily distribution, added to their **base rewards**. Learn more about the daily rewards at the [Reward Mechanism (RM) ](/reward-mechanism) section.
