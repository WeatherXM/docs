...
which may share the rewards. Should the number of eligible bounty stations exceed the bounty capacity, a ranking based on [QoD scores](/weather-and-science/quality-mechanisms/general-qod-description.mdx) and seniority is used
