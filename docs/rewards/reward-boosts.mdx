...
Correction Rewards are a special type of boost rewards which are meant to distribute tokens which were initially not allocated due to system and/or algorithm malfunctions.
