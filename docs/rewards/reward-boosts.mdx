...
- Backfill of rewards that were not allocated to certain devices due to malfunctions in the [Data Quality algorithm](/rewards/quality-of-data) or [Proof of Location (PoL) mechanism](/rewards/proof-of-location).
