...
<hr />
  ...
  For now we support only MetaMask as it has a very good testnet support and our dev team prefers it. When we move on Mainnet you will be able to use your preferred wallet.
