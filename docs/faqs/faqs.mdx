...
## <Highlight color="#68a4f9">Troubleshooting</Highlight>
  ...
  Please do not restart it and DM <Highlight color="#7289da">Alexandra#5083</Highlight> on Discord to debug it and find the reason of the issue.
...
## <Highlight color="#68a4f9">Beta testing</Highlight>
  ...
  Please DM <Highlight color="#7289da">Alexandra#5083</Highlight> on Discord and provide the following info: email address and serial number of your device or station name.
