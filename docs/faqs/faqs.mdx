...
## <Highlight color="#68a4f9">Troubleshooting</Highlight>
  ...
  Please do not restart it and contact us via our [support email](mailto:hello@weatherxm.com) or via the [contact form on our website](https://weatherxm.com/contact-us/) to debug it and find the reason of the issue.
...
## <Highlight color="#68a4f9">Beta testing</Highlight>
  ...
  Please contact us via our [support email](mailto:hello@weatherxm.com) or via the [contact form on our website](https://weatherxm.com/contact-us/) and provide the following info: email address and serial number of your device or station name.
