...
## <Highlight color="#68a4f9">Troubleshooting</Highlight>
  ...
  Please do not restart it and DM <Highlight color="#7289da">Lyna#2670</Highlight> or <Highlight color="#7289da">Alexandra#5083</Highlight> on Discord to debug it and find the reason of the issue.
...
## <Highlight color="#68a4f9">Beta testing</Highlight>
  ...
  Currently, we don't have affiliate programs but if we do in the future we will make announcements regarding them.