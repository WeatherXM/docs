...
## <Highlight color="#68a4f9">Rewards</Highlight>
  ...
  According to our [whitepaper](https://docs.google.com/document/d/1_z-sdCoSpm7H5kH0Ko8grUn7IatmAObSdkQULr21YGc/edit)
...
## <Highlight color="#68a4f9">Software</Highlight>
  ...
  Such details will be defined in our [whitepaper](https://docs.google.com/document/d/1_z-sdCoSpm7H5kH0Ko8grUn7IatmAObSdkQULr21YGc/edit). Currently one station per cell should be the best case scenario.
  ...
  In case you place 5 stations in the same Hex your rewards will be split, we don't know exactly how much since such info will be defined in our [whitepaper](https://docs.google.com/document/d/1_z-sdCoSpm7H5kH0Ko8grUn7IatmAObSdkQULr21YGc/edit).
