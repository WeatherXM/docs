...
1. [Using Polygonscan](/wallet/creating-wallet#using-polygonscan) **(Only for Desktop with MetaMask browser extension already installed)**
1. [Add the Polygon network manually](/wallet/creating-wallet#add-the-polygon-network-manually)
