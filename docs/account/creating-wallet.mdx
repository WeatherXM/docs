...
1. [Using Polygonscan](/account/creating-wallet#using-polygonscan) **(Only for Desktop with MetaMask browser extension already installed)**
1. [Add the Polygon network manually](/account/creating-wallet#add-the-polygon-network-manually)
