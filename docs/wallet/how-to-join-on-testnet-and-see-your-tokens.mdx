...
- New RPC URL: The URL of an RPC Server in the Mumbai testnet. You can see a [list of available servers here](https://chainlist.org/chain/80001?testnets=true).
- Chain ID: 80001
...
After you have entered the required information, it should look as follows:

:::note IMPORTANT NOTE
The following is only an example. You should always retrieve a valid [RPC URL](https://chainlist.org/chain/80001?testnets=true).
:::

<img class="marginTopBottomNormal" src={useBaseUrl("img/project/suggested-wallets/metamask-settings-mumbai-example.png")} />
