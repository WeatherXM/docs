...
1. [Using Polygonscan](/wallet/adding-wallet#using-polygonscan) **(Only for Desktop with MetaMask browser extension already installed)**
1. [Add the Polygon network manually](/wallet/adding-wallet#add-the-polygon-network-manually)
