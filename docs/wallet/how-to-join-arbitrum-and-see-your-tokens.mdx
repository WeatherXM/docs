...
Please follow the steps to add Arbitum one Testnet (also known as Sepolia Testnet):

1. Make sure that you have successfully added Arbitrum One Mainnet to your Metamask.
2. Open Metamask and look for the network selection tool located at the upper left corner.
3. Enable the "Show Test Networks" option.
4. From the dropdown list, select "Sepolia" test network.

<img class="marginTopBottomNormal" src={useBaseUrl("/img/wallet/add_sepolia_testnet.png")} />

:::tip 
Alternatively you can add Arbitrum One Testnet by following the steps below:

Visit the official [Arbitrum One Testnet](https://testnet.arbiscan.io/) and then click on the button `Add to Metamask`.

or

Visit the official Documentation [Arbitrum One Testnet](https://developer.offchainlabs.com/docs/developer_quickstart) and then click on the button `Add to Metamask`.
:::
</TabItem>
...
1. First, you will need the following details of the WXM token in order to add it:
    1. **Token Contract Address:** ``0xDce8e61d46091C2b963785437D02eE1e4F3F7B36``
    1. **Token Symbol:** ``MXW``
    1. **Token Decimal:** ``18``

You can verify those details on [Sepolia Arbiscan](https://sepolia.arbiscan.io/address/0xDce8e61d46091C2b963785437D02eE1e4F3F7B36).
...
:::note
The ticker symbol for WXM is temprorarily until mainet **MXW**.
:::
