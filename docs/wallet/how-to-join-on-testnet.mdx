---
id: how-to-join-on-testnet
title: How to join on testnet
sidebar_label: How to join on testnet
slug: /wallet/how-to-join-on-testnet
---
...
1. [Using Polygonscan](/wallet/how-to-join-on-testnet#using-polygonscan) **(Only for Desktop with MetaMask browser extension already installed)**
1. [Add the Polygon network manually](/wallet/how-to-join-on-testnet#add-the-polygon-network-manually)
